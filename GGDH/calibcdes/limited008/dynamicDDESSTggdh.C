...
//	dimensionedScalar("lzero", dimLength*dimLength, 0.0)
    ...
    mesh_,
    dimensionedScalar("CDES", dimLength/dimLength, 0.08)
    ),
/*
    CDES0_
    (
...
*/
    ...
    mesh_,
    dimensionedScalar("crans1", dimLength/dimLength, -1.2)
    ),
    crans2_
    (
        IOobject
    ...
    mesh_,
    dimensionedScalar("crans2", dimLength/dimLength, -1.8)
    ),
    ctdyn_
    (
        IOobject
...
void dynamicDDESSTggdh::update_nut()
{
    ...
    volScalarField crans_ = crans1_ + fdl_*(crans2_ - crans1_);
